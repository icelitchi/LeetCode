...
public class ConstructBinaryTreeInorderPostorderTraversal {
	...
	public static void main(String[] args) {
		...
		ConstructBinaryTreeInorderPostorderTraversal t=new ConstructBinaryTreeInorderPostorderTraversal();
		int[] inorder={1,2};
		int[] postorder={2,1};
    ...
    TreeNode buildTree(int[] inorder,int start1,int end1, int[] postorder,int start2,int end2) {
    	...
    	if(rightTreeSize>0)
    		root.right=buildTree(inorder,inRootIndex+1,end1,postorder,start2+leftTreeSize,end2-1);
    	return root;
